...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-tzinfo-data-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7689&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-tzinfo-data-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-tzinfo-data` can be installed with:

```
conda install rb-tzinfo-data
```

It is possible to list all of the versions of `rb-tzinfo-data` available on your platform with:
